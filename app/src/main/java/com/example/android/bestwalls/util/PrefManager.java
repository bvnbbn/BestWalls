...
public class PrefManager
{
    ...
    //storing number of grid columns


    public void setNoGridOfColumns(int columns) {
        editor = pref.edit();
    ...
    public void  setGaleryName(String galleryName)
    {
        editor = pref.edit();
    ...
    //storing albums in shared prefernces
   ...
   /* Fetching albums from shared prefernces .Albums will
   be sorted before returning in alphabetical  order
    */
